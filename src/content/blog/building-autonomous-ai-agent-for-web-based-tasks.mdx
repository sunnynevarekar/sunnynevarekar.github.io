...
<figure>
  ...
  <figcaption>Fig. High-level architecture showing the three core components: Perception, Reasoning, and Execution modules working together to create an autonomous web agent</figcaption>
</figure>
